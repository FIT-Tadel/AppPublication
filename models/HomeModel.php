    ...
    class Home {
        public static function displayHomepage() {
            ...
            if(isset($_SESSION["isLogin"]) && $_SESSION["isLogin"] === true) {
                ...
                //Load Header: UserAvatar, Session-UserInfo, Status, Role...
                ...
                //Load Papers
                $papers = Home::getPapers();
                Helper::runScript("loadPapersDashboard('$papers')");
            }
        }
        ...
        public static function getPapers() {
            ...
            $sql = "SELECT p.paper_id, t.topic_name, p.title, p.author_string_list, p.abstract as description, u.username as user_upload
                    FROM papers p
                    INNER JOIN topics t ON p.topic_id = t.topic_id
                    INNER JOIN users u ON u.user_id = p.user_id
                    ORDER BY(t.topic_name);";
            $db->execute($sql);
            $papers = $db->getAllData();
            $db->close();
            //Debug
